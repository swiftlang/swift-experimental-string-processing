...
@_silgen_name("_swift_stdlib_isLinkingConsonant")
func _swift_stdlib_isLinkingConsonant(_: UInt32) -> Bool

@_silgen_name("_swift_stdlib_getGraphemeBreakProperty")
func _swift_stdlib_getGraphemeBreakProperty(_: UInt32) -> UInt8
