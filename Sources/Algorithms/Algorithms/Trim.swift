extension Collection {
  public func trimmingPrefix<C: CollectionConsumer>(_ consumer: C) -> SubSequence where C.Consumed == Self {
...
extension Collection where SubSequence == Self {
  public mutating func trimPrefix<C: CollectionConsumer>(_ consumer: C) where C.Consumed == Self {
...
extension BidirectionalCollection {
  public func trimmingSuffix<C: BackwardCollectionConsumer>(_ consumer: C) -> SubSequence where C.Consumed == Self {
...
extension BidirectionalCollection where SubSequence == Self {
  public mutating func trimSuffix<C: BackwardCollectionConsumer>(_ consumer: C) where C.Consumed == Self {
...
// TODO: Reinstate these once we figure out bidirectional consumers
...
extension Collection {
  public func trimmingPrefix(while predicate: @escaping (Element) -> Bool) -> SubSequence {
    ...
    return self.trimmingPrefix(consumer)
  }
}
