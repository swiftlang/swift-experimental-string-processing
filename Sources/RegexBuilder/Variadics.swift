...
extension RegexComponentBuilder {
  ...
  public static func buildPartialBlock<W0, W1, C1, R0: RegexComponent, R1: RegexComponent>(
    ...
    .init(_node: accumulated.regex._root._appending(next.regex._root))
  }
}
@available(SwiftStdlib 5.7, *)
extension RegexComponentBuilder {
...
extension Optionally {
  ...
  public init<Component: RegexComponent>(
    ...
    self.init(_node: .quantification(._zeroOrOne, kind, component.regex._root))
  }
}
...
extension RegexComponentBuilder {
  ...
  public static func buildLimitedAvailability<Component: RegexComponent>(
    ...
    .init(_node: .quantification(._zeroOrOne, .default, component.regex._root))
  }
}
@available(SwiftStdlib 5.7, *)
extension ZeroOrMore {
  ...
  public init<Component: RegexComponent>(
    ...
    let kind:_DSLTree._QuantificationKind = behavior.map { .explicit($0._dslTreeKind) } ?? .default
    self.init(_node: .quantification(._zeroOrMore, kind, component.regex._root))
  }
}
...
extension OneOrMore {
  ...
  public init<Component: RegexComponent>(
    ...
    let kind:_DSLTree._QuantificationKind = behavior.map { .explicit($0._dslTreeKind) } ?? .default
    self.init(_node: .quantification(._oneOrMore, kind, component.regex._root))
  }
}
...
extension Repeat {
  ...
  public init<Component: RegexComponent>(
    ...
    self.init(_node: .quantification(._exactly(count), .default, component.regex._root))
  }
  ...
  public init<Component: RegexComponent, R: RangeExpression>(
    ...
    self.init(_node: .repeating(expression.relative(to: 0..<Int.max), behavior, component.regex._root))
  }
...
extension Local {
  ...
  public init<Component: RegexComponent>(
    ...
    self.init(_node: .nonCapturingGroup(._atomicNonCapturing, component.regex._root))
  }
}
...
extension AlternationBuilder {
  ...
  public static func buildPartialBlock<R0, R1>(
    ...
    .init(_node: accumulated.regex._root._appendingAlternationCase(next.regex._root))
  }
}
@available(SwiftStdlib 5.7, *)
extension AlternationBuilder {
...
extension AlternationBuilder {
  ...
  public static func buildPartialBlock<R, W, C1>(first regex: R) -> ChoiceOf<(W, C1?)> where R: RegexComponent, R.RegexOutput == (W, C1) {
    .init(_node: .orderedChoice([regex.regex._root]))
  }
}
@available(SwiftStdlib 5.7, *)
extension AlternationBuilder {
...
extension Capture {
  ...
  public init<R: RegexComponent, W>(
    ...
    self.init(_node: .capture(component.regex._root))
  }
  ...
  public init<R: RegexComponent, W>(
    ...
    self.init(_node: .capture(reference: reference.id, component.regex._root))
  }
  ...
  public init<R: RegexComponent, W, NewCapture>(
    ...
    self.init(_node: .capture(
      component.regex._root,
      _CaptureTransform(transform)))
  }
